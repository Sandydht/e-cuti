                ...
                <CardContent>
                  <Formik
                    ...
                    onSubmit={(values, { setSubmitting }) => {
                      Axios.post(`/aproval/${this.props.match.params.cutiId}`, values)
                        .then(() => {
                          setSubmitting(false);
                          this.props.enqueueSnackbar("Aproval berhasil", { variant: "success", preventDuplicate: true });
                          this.props.history.replace("/");
                        })
                        .catch(() => {
                          setSubmitting(false);
                          this.props.enqueueSnackbar("Aproval gagal", { variant: "error", preventDuplicate: true });
                        });
                    }}
                  >
                    {({
...
export default withSnackbar(Aproval);
