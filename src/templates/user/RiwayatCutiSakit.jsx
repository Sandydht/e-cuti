...
class RiwayatCutiSakit extends Component {
  ...
  riwayatCuti = (data) => {
    this.setState({
      isLoading: false,
      data: data.filter(data => data.jenisCuti === 'Cuti Sakit')
    });
  };
              ...
              customBodyRenderLite: (dataIndex) => {
                return (
                  <Button
                    ...
                    onClick={() => {
                      Axios.post('/readNotifikasi', { notifikasiId }).then(() => this.props.history.push(`/riwayat_cuti_sakit/${data[dataIndex].cutiId}`));
                    }}
                  >Detail</Button>
                );
              }
